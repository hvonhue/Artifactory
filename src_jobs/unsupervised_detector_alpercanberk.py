...
class VAE(pl.LightningModule):
    def __init__(
        ...
        **kwargs
        ...
        self.encoder = nn.Sequential(
            nn.Flatten(),
            nn.Linear(input_channels * input_height * input_width, 392),
            nn.BatchNorm1d(392),
            nn.LeakyReLU(0.1),
            nn.Linear(392, 196),
            nn.BatchNorm1d(196),
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_kl_loss", kl.mean(), on_step=True, on_epoch=True, prog_bar=True)
        self.log(
            "train_recon_loss",
            recon_loss.mean(),
            on_step=True,
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_kl_loss", kl.mean())
        self.log("val_recon_loss", recon_loss.mean())
