"""
python train_CNN.py
--input-path /workspaces/AICoE_Ramping_Artefacts/artifactory-master/data/processed
--val-path /workspaces/AICoE_Ramping_Artefacts/artifactory-master/data/validation_slidingWindow_512.pkl
--output-path /workspaces/AICoE_Ramping_Artefacts/artifactory-master/data/output
"""
import pickle
import warnings
...
def main(
    ...
    logger = MLFlowLogger(
        log_model="all",
        run_name=model_name,
        experiment_name="artifactory_CNN_detector",
    ...
    checkpointcallback = ModelCheckpoint(
        dirpath=output_path, monitor="validation", mode="min", save_top_k=1
    )
