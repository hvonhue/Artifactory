"""
python train_CNN_dense.py --input-path /workspaces/AICoE_Ramping_Artefacts/artifactory-master/data/processed --val-path /workspaces/AICoE_Ramping_Artefacts/artifactory-master/data/validation_slidingWindow_London512.pkl --output-path /workspaces/AICoE_Ramping_Artefacts/artifactory-master/data/output
"""
import pickle
import warnings
