...
class LinearSlidingWindowTransformerDetector(LightningModule):
    """Use convolutional layers to extract features, then use them
    in a transformer block, 2 linear layers to convert back to prediction"""
